...
public class ContaController {
	...
	public ResponseEntity<ContaDto> transferir(@PathVariable Integer agencia, @PathVariable Integer numeroConta, @RequestBody @Valid TransferenciaContaRequest transferenciaContaRequest) {
		
		logger.info("transferir agencia {}, conta {}", agencia, numeroConta);
		
		var conta = contaService.transferir(agencia, numeroConta, BigDecimal.valueOf(transferenciaContaRequest.getValor()), transferenciaContaRequest.getAgencia(), transferenciaContaRequest.getConta());
